...
//Struct for VBE Function 00h Return VBE Controller Information
typedef struct {
...
//Returns information of the display controller
//Initializes vbe_controller_info_t struct passed by address
//Returns 0 on success, non-zero otherwise
int vbe_get_controller_info(mmap_t* lmblock, vbe_controller_info_t* vci_p);
